...
MapGroup_Cerulean:
	...
	map CeruleanCave, TILESET_CAVE, CAVE, CERULEAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_NITE, FISHGROUP_NONE
...
MapGroup_FastShip:
	...
	map FarawayIslandOutside, TILESET_KANTO, ROUTE, TIN_TOWER, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FarawayIslandCave, TILESET_CAVE, ROUTE, TIN_TOWER, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
