...
MapGroup_Dungeons:
	...
	map SilverCaveMoltresRoom, TILESET_CAVE, CAVE, SILVER_CAVE, MUSIC_LIGHTHOUSE, FALSE, PALETTE_NITE, FISHGROUP_LAKE
	map SafariZone2, TILESET_PARK, ROUTE, FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariZone3, TILESET_PARK, ROUTE, FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map SeafoamIslandB1F, TILESET_CAVE, CAVE, SEAFOAM_ISLANDS, MUSIC_VIRIDIAN_CITY, 0, PALETTE_DAY, FISHGROUP_OCEAN
...
MapGroup_Cerulean:
	...
	map CeruleanCave, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_NITE, FISHGROUP_NONE
...
MapGroup_FastShip:
	...
	map FarawayIslandOutside, TILESET_KANTO, ROUTE, FARAWAY_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FarawayIslandCave, TILESET_CAVE, ROUTE, FARAWAY_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
