...
ENDM
	...
	connection west, SafariZone2, SAFARI_ZONE_2, 0, 0, 10
	connection east, SafariZone3, SAFARI_ZONE_3, 0, 0, 10
	...
	connection east, SafariZoneBeta, SAFARI_ZONE_BETA, 0, 0, 14

	map_attributes SafariZone3, SAFARI_ZONE_3, 0, WEST
	connection west, SafariZoneBeta, SAFARI_ZONE_BETA, 0, 0, 14
