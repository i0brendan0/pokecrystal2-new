...
UnownWordEX: unownword "EXCLAIM"
UnownWordQU: unownword "QUESTION"
UnownWordPE: unownword "STOP"
UnownWordCO: unownword "PAUSE"
UnownWordHY: unownword "CONNECT"
UnownWordIN: unownword "INTERUPT"
; fbb32
