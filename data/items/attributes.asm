...
; ITEMFINDER
	item_attribute 0, 0, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; WHITE_WING
	item_attribute 100, HELD_BIRD_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; EXP_SHARE
...
; GOLD_LEAF
	item_attribute 1000, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SOFT_SAND
	item_attribute 100, HELD_GROUND_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SHARP_BEAK
	item_attribute 100, HELD_FLYING_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PRZCUREBERRY
...
; POISON_BARB
	item_attribute 100, HELD_POISON_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; KINGS_ROCK
...
; SILVERPOWDER
	item_attribute 100, HELD_BUG_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLU_APRICORN
	item_attribute 200, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LIGHT_ORB
	item_attribute 100, HELD_LIGHT_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; AMULET_COIN
...
; MYSTIC_WATER
	item_attribute 100, HELD_WATER_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; TWISTEDSPOON
	item_attribute 100, HELD_PSYCHIC_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WHT_APRICORN
	item_attribute 200, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACKBELT
	item_attribute 100, HELD_FIGHTING_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLK_APRICORN
	item_attribute 200, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACK_BOX
	item_attribute 100, HELD_CHAOS_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PNK_APRICORN
	item_attribute 200, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACKGLASSES
	item_attribute 100, HELD_DARK_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SLOWPOKETAIL
	item_attribute 9800, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PINK_BOW
	item_attribute 100, HELD_NORMAL_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; STICK
	item_attribute 200, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SMOKE_BALL
	item_attribute 200, HELD_ESCAPE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; NEVERMELTICE
	item_attribute 100, HELD_ICE_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MAGNET
	item_attribute 100, HELD_ELECTRIC_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MIRACLEBERRY
...
; EVERSTONE
	item_attribute 200, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SPELL_TAG
	item_attribute 100, HELD_GHOST_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; RAGECANDYBAR
	item_attribute 300, 0, 20, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; GS_BALL
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLUE_CARD
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; MIRACLE_SEED
	item_attribute 100, HELD_GRASS_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; THICK_CLUB
	item_attribute 500, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FOCUS_BAND
	item_attribute 200, HELD_FOCUS_BAND, 30, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MYSTIC_CARD
	item_attribute 100, HELD_MYSTERY_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ENERGYPOWDER
...
; HARD_STONE
	item_attribute 100, HELD_ROCK_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LUCKY_EGG
	item_attribute 200, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CARD_KEY
...
; ITEM_89
	item_attribute $9999, 0, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHARCOAL
	item_attribute 9800, HELD_FIRE_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BERRY_JUICE
...
; ITEM_8E
	item_attribute $9999, 0, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; METAL_COAT
	item_attribute 100, HELD_STEEL_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_PARTY, ITEMMENU_NOUSE
; DRAGON_FANG
	item_attribute 100, HELD_DRAGON_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_91
	item_attribute $9999, 0, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LEFTOVERS
...
; SUN_STONE
	item_attribute 2100, 0, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; POLKADOT_BOW
	item_attribute 100, HELD_FAIRY_BOOST, 10, CANT_SELECT, HOLDING, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_AB
	item_attribute $9999, 0, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; UP_GRADE
	item_attribute 2100, 0, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
