TypeBoostItems: ; 35703
	...
	db HELD_BIRD_BOOST,     BIRD     ; WHITE_WING
	db HELD_FAIRY_BOOST,    FAIRY_T  ; POLKADOT_BOW
	db HELD_CHAOS_BOOST,    CHAOS_T  ; BLACK_BOX
	db HELD_LIGHT_BOOST,    LIGHT_T  ; LIGHT_ORB
	db HELD_MYSTERY_BOOST,  MYSTERY_T; MYSTIC_CARD
	db -1
; 35726
