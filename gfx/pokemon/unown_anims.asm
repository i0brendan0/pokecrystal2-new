...
UnownPeriodAnimation:      INCLUDE "gfx/pokemon/unown_period/anim.asm"
UnownCommaAnimation:       INCLUDE "gfx/pokemon/unown_comma/anim.asm"
UnownHyphenAnimation:      INCLUDE "gfx/pokemon/unown_hyphen/anim.asm"
UnownInterrobangAnimation: INCLUDE "gfx/pokemon/unown_interrobang/anim.asm"