...
UnownPeriodAnimationExtra:      INCLUDE "gfx/pokemon/unown_period/anim_idle.asm"
UnownCommaAnimationExtra:       INCLUDE "gfx/pokemon/unown_comma/anim_idle.asm"
UnownHyphenAnimationExtra:      INCLUDE "gfx/pokemon/unown_hyphen/anim_idle.asm"
UnownInterrobangAnimationExtra: INCLUDE "gfx/pokemon/unown_interrobang/anim_idle.asm"
