...
UnownPeriodBitmasks:      INCLUDE "gfx/pokemon/unown_period/bitmask.asm"
UnownCommaBitmasks:       INCLUDE "gfx/pokemon/unown_comma/bitmask.asm"
UnownHyphenBitmasks:      INCLUDE "gfx/pokemon/unown_hyphen/bitmask.asm"
UnownInterrobangBitmasks: INCLUDE "gfx/pokemon/unown_interrobang/bitmask.asm"
