...
;UnownPeriodFrontpic:      INCBIN "gfx/pokemon/unown_period/front.animated.2bpp.lz"
;UnownPeriodBackpic:       INCBIN "gfx/pokemon/unown_period/back.2bpp.lz"
;UnownCommaFrontpic:       INCBIN "gfx/pokemon/unown_comma/front.animated.2bpp.lz"
;UnownCommaBackpic:        INCBIN "gfx/pokemon/unown_comma/back.2bpp.lz"
;UnownHyphenFrontpic:      INCBIN "gfx/pokemon/unown_hyphen/front.animated.2bpp.lz"
;UnownHyphenBackpic:       INCBIN "gfx/pokemon/unown_hyphen/back.2bpp.lz"
;UnownInterrobangFrontpic: INCBIN "gfx/pokemon/unown_interrobang/front.animated.2bpp.lz"
;UnownInterrobangBackpic:  INCBIN "gfx/pokemon/unown_interrobang/back.2bpp.lz"
